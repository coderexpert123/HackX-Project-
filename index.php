...
<h3 class="text-center">Code-War Categories..</h3>
</div>

<div class="row">
<!------Fetc all te card from  te dtatvvabs----->
<?php
...
<div class="col-md-4 my-2">
        ...
        <img class="card-img-top" src="https://source.unsplash.com/1600x900/?'.$cat.',coding" alt="Card image cap">
          <div class="card-body">
            <h5 class="card-title"><a href="treadsList.php?catid='.$id.'">'.$cat.'</a></h5>
            <p class="card-text">'.substr($desc,0,20).'....</p
            >
            <a href="treadsList.php?catid='.$id.'" class="btn btn-primary " >See Categories</a>
          </div>
        </div>
